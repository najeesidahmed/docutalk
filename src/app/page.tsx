...
export default function Home() {
  return (
    ...
    <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
      <div className="mx-auto mb-4 flex max-w-ft items-center justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50">
        <p className="text-sm font-semibold text-gray-700">Docutalk is now live!</p>
      </div>
      <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
        Chat with your <span className="text-blue-600">documents</span> in seconds.
      </h1>
      <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
        Docutalk allows you to have conversations with any PDF document. Simply upload your file and start asking questions right away.
      </p>
      ...
      <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
        <div className='mb-12 px-6 lg:px-8'>
          <div className='mx-auto max-w-2xl sm:text-center'>
            ...
            <p className='mt-4 text-lg text-gray-600'>Chatting to your files has never been easier than with Docutalk.</p>
          </div>
        </div>
        ...
        <ol className='my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0'>
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
              ...
              <span className='mt-2 text-zinc-700'>Either starting out with a free plan our choose our {' '}
          ...
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
              ...
              <span className='text-xl font-semibold'>Start asking questions</span>
                It&apos;s that simple. Try out Docutalk today - it really takes less than a minute.
            </div>
          </li>
        </ol>
